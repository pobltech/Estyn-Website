@include('partials.inside-hero', [
    'title' => get_the_title(),
    'heroImageID' => !empty(get_field('provider_hero_image', get_the_ID())) ? get_field('provider_hero_image')['ID'] : null,
    'heroImageSrc' => asset('images/' . ESTYN_PROVIDER_DEFAULT_HERO_IMAGE_FILENAME), // Fallback image
    'heroImageAlt' => __('Estyn logo on a blue background', 'sage'), // Fallback alt
    ...
    'insideIntroLinks' => [
        [
            'url' => '#' . __('inspection-reports', 'sage'),
...
<div class="reportMain pb-5">
    <div class="container px-md-4 px-xl-5 mt-5 pt-md-5">
        <div class="row" id="{{ __('inspection-reports', 'sage') }}">
            <div class="col-12">
    ...
    <div class="container px-md-4 px-xl-5">
        <div class="row" id="{{ __('contact-details', 'sage') }}">
            <div class="col-12">
                <hr>
            </div>
        </div>
