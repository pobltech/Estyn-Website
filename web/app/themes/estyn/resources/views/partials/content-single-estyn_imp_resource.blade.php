...
<?php
    ...
    if($resourceTypes) {
        ...
        foreach($resourceTypes as $resourceType) {
            ...
            if( ($resourceType->slug == __('thematic-report', 'sage')) || ($resourceType->slug == 'thematic-report') ) {
              //$pageHeaderArgs['fullWidth'] = true;

              //echo '<h2>' . __('Thematic Report', 'sage') . '</h2>';

              $isThematicReport = true;
            } elseif ($resourceType->slug == __('effective-practice', 'sage') || $resourceType->slug == 'effective-practice') {
              $isEffectivePractice = true;
            } elseif ($resourceType->slug == __('annual-report', 'sage') || $resourceType->slug == 'annual-report') {
              $isAnnualReport = true;
            } elseif ($resourceType->slug == __('additional-resource', 'sage') || $resourceType->slug == 'additional-resource') {
